"""
Караоке-субтитры для «Персефона и Аид».
...
Что делает:
  ...
  6. Кэширует транскрипции в pyCapCut/_karaoke_cache_persephone.json.
...
CACHE_FILE = Path(__file__).resolve().parent / "_karaoke_cache_persephone.json"
