"""
Сборка CapCut-драфта «Дионис и Ариадна» через pyCapCut.

25 предложений озвучки → 24 видеошота в 24 таймлайн-сценах. Сцена 001
содержит хук + интро. CTA-аутро нет — финальный кадр заканчивается по
последней озвучке.

Использование:
    python build_dionysus.py                                  # автоопределение папки CapCut
    python build_dionysus.py --drafts "D:\\...\\com.lveditor.draft"
    python build_dionysus.py --name "Дионис v2"
    python build_dionysus.py --dry-run                        # только напечатать план таймлайна
"""
...
from scene_structure_dionysus import SCENES, Scene
...
DEFAULT_PROJECT_NAME = "Дионис и Ариадна"
...
MYTH_ROOT = PROJECT_ROOT / "content" / "Дионис и Ариадна"
...
STICKER_PLAN = [
    ...
    ("scene_02_v1.mp4", "scene_02/scene_02_royal.jpeg", 0.54, 0.39, 0.245, "coin"),
    ("scene_05_v1.mp4", "scene_05/scene_05_naxos_five_star_review.jpg", 0.54, 0.40, 0.245, "coin"),
    ("scene_08_v1.mp4", "scene_08/scene_08_error_404_husband_missing.jpg", -0.54, 0.38, 0.245, "mouse"),
    ("scene_09_v1.mp4", "scene_09/scene_09_no_signal_naxos_abandoned.jpg", 0.54, 0.38, 0.245, "pac"),
    ("scene_11_v1.mp4", "scene_11/scene_11_crickets_silence_speech_bubble.jpg", -0.54, 0.38, 0.245, "mouse"),
    ("scene_13_v1.mp4", "scene_13/scene_13_grape_cruise_advertisement_ticket.jpg", 0.54, 0.40, 0.245, "coin"),
    ("scene_14_v1.mp4", "scene_14/scene_14_dionysus_tinder_profile_card.jpg", -0.54, 0.39, 0.245, "pac"),
    ("scene_16_v1.mp4", "scene_16/scene_16_love_match_critical_hit.jpg", 0.54, 0.38, 0.245, "coin"),
    ("scene_17_v1.mp4", "scene_17/scene_17_marry_dionysus_rpg_dialog.jpg", 0.52, 0.39, 0.245, "pac"),
    ("scene_18_v1.mp4", "scene_18/scene_18_olympus_wedding_invite_gold.jpg", -0.54, 0.39, 0.245, "coin"),
    ("scene_21_v1.mp4", "scene_21/scene_21_widowed_god_status_card.jpg", 0.54, 0.38, 0.245, "mouse"),
    ("scene_23_v1.mp4", "scene_23/scene_23_corona_borealis_achievement_unlocked.jpg", 0.0, 0.43, 0.265, "coin"),
]
...
def main() -> int:
    p = argparse.ArgumentParser(description="Собрать CapCut-драфт «Дионис и Ариадна» через pyCapCut.")
    ...
    if drafts is None or not drafts.is_dir():
        print(
            ...
            "  python build_dionysus.py --drafts "
